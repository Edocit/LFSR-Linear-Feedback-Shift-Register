...
HD_PWD='C:/Users/edoardo/Desktop/Vivado/LFSR/LFSR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LFSR_16_BIT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LFSR_16_BIT.tcl
