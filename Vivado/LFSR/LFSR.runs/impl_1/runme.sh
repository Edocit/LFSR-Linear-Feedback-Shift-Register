...
HD_PWD='C:/Users/edoardo/Desktop/Vivado/LFSR/LFSR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LFSR_16_BIT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LFSR_16_BIT.tcl -notrace
